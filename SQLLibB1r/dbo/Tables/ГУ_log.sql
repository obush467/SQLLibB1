CREATE TABLE [dbo].[ГУ_log] (
    ...
    [GU_ID]                                                            UNIQUEIDENTIFIER  NULL,
    [log_d]                                                            DATETIME          CONSTRAINT [DF_ГУ_log_d] DEFAULT (getdate()) NOT NULL,
    CONSTRAINT [PK_ГУ_log] PRIMARY KEY NONCLUSTERED ([ID_log] ASC)
);
