...
set  @AddressCursor=cursor
	...
	WITH child_to_parents AS (
	  SELECT FORMALNAME,SHORTNAME,AOGUID,PARENTGUID,AOLEVEL FROM fias_Moscow.Object
		  WHERE aoGUid = @AOGUID
	  UNION ALL
	  SELECT o1.FORMALNAME,o1.SHORTNAME,o1.AOGUID,o1.PARENTGUID,o1.AOLEVEL FROM fias_Moscow.Object o1, child_to_parents
